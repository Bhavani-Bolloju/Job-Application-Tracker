  ...
  return (
    <div>
      <div className="flex items-stretch gap-4">
        <Link
          href="/applications"
          className="flex items-center gap-2 py-2 px-4 border-2 border-border rounded-md mr-auto"
        >
          <ChevronLeft />
          <span>Back</span>
        </Link>
        <Button
          variant="outline"
          className="flex items-center gap-2 py-2 px-4 border-2 border-border! rounded-md self-stretch h-auto"
          onClick={handleEdit}
        >
        ...
        {url && (
          <a
            href={url}
            target="_blank"
            className="flex items-center gap-2 py-2 px-4 border border-border rounded-md"
          >
      ...
      <div className="grid grid-cols-[auto_1fr_auto] my-5 gap-x-5 mt-8">
        <div className="col-start-1 col-end-2 row-start-1 row-end-4 px-10 flex items-center justify-center text-4xl uppercase rounded-md shadow-md shadow-gray-200 border border-border ">
          {company[0]}
        </div>
        ...
        <div className="col-start-2 col-end-3 row-start-3 row-end-4 self-start flex items-center gap-2 mt-4">
